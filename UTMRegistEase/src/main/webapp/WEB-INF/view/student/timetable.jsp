...
>>>>>>> refs/remotes/origin/SecurityConfig
		...
		<form method="get" action="/UTMRegistEase/student/search"
		...
		<c:if test="${not empty param.searchQuery}">
			<form method="get" action="/UTMRegistEase/student/viewTimetable"
				style="margin-left: 180px; margin-bottom: 20px;">
				<button type="submit" class="back-button">Back to View
					Timetable</button>
			</form>
		</c:if>
		<table>
